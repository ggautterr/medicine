"use strict";
let tableStore = function () {
    let t, e, o = () => {
    };
    return {
        init: function () {
            (t = document.querySelector("#table_store")) && ((e = $(t).DataTable({
                info: !1,
                pageLength: 50,
                ...
                columnDefs: [{orderable: true, targets: 0}, {orderable: false, targets: 1,},
                    {orderable: false, targets: 2,}, {orderable: true, targets: 3,}, {orderable: false, targets: 4,}],
            })).on("draw", (function () {
                o()
            })),
                document.querySelector('[data-table-search="search"]').addEventListener("keyup", (function (t) {
                    e.column(0).search(t.target.value).draw()
                })), o())
        }
    }
}();

"use strict";
let tableWorkerVocation = function () {
    let t, e, o = () => {};
    return {
        init: function () {
            (t = document.querySelector("#table_worker_vocation")) && ((e = $(t).DataTable({
                info: !1,
                order: [],
                pageLength: 50,
                ...
                buttons: [
                    {
                        ...
                        customize: function (xlsx) {
                            $( 'sheets sheet', xlsx.xl['workbook.xml'] ).attr( 'name', 'Отпускные' );
